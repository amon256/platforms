								...
								<div class="input-group">
									...
									<c:choose>
										<c:when test="${empty accounts }">
											<input type="text" class="form-control" id="account" name="account" value="${user.account }" placeholder="六位数字">
										</c:when>
										<c:otherwise>
											<input type="text" class="form-control" id="account" name="account" value="${user.account }" list="accountList" placeholder="六位数字">
