...
<body>
	<div class="container-fluid">
		...
		<form id="editUser" role="form" class="form-horizontal" action="${ctx }/user/userSave" method="post">
			...
			<button type="submit" class="btn btn-primary">修改个人资料</button>&nbsp;<button type="button" class="btn btn-info" onclick="window.history.go(-1);">返回</button>
		</form>
	</div>
</body>
</html>