					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <!-- The user image in the navbar--> 
								...
								<span class="hidden-xs">${user.name }(${user.account })</span>
							</a>
							<ul class="dropdown-menu">
								<!-- The user image in the menu -->
								<li class="user-header"><img src="${ctx}${user.headPhoto}" class="img-circle" alt="User Image">
									<p>
										${user.name }(${user.account })<small>Member since <fmt:formatDate value="${user.createTime }" pattern="yyyy.MM"/></small>
									</p>
								</li>
								<!-- Menu Body -->
								<li class="user-body">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="${ctx }/${cus:url(null,'/adminuser/toProfile')}" class="btn btn-default btn-flat">配&nbsp;置</a>
									</div>
